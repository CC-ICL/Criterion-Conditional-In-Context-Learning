...
- MCT Model Behavior: The MCT-trained model actively conditions its reasoning on the support set, using it as a dynamic reference to calibrate decision boundaries for each specific task. 
